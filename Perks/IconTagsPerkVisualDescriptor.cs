...
public class IconTagsPerkVisualDescriptor : StandardPerkVisualDescriptor
{
    private const int
        FrameX = 16,
        FrameY = 5,
    ...
    {
        spriteBatch.Draw(icon.Value, location, _sourceRectangle, color, 0, _origin, scale, SpriteEffects.None, 0);
    }
