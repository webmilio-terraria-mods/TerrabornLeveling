...
public class OneWithTheBobber : Perk
{
    ...
    public override IPerkVisualDescriptor Visuals { get; } = new PerkVisualDescriptor(new(0.67490494f, 0.71146953f), new(30, 30), Main.Assets.Request<Texture2D>($"Images/Projectile_{ProjectileID.BobberFiberglass}"));
}